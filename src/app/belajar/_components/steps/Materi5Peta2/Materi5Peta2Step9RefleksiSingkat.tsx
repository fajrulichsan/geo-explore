...
export default async function Materi5Peta2Step9RefleksiSingkat({
  ...
  return (
    <form action={submitStepAction} className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_180px] gap-5 items-center bg-gradient-to-br from-[#FEF9E7] to-[#FFF7ED] border border-[#F5E3A0] rounded-[24px] p-6 sm:p-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="m-0 text-sm leading-[1.6] text-[#78350F]">
            Dugaanmu belum tentu benar. Pada tahap berikutnya kamu akan membuktikannya melalui diskusi dan
            eksplorasi bersama teman sekelompok.
          </p>
        </div>
        <EditablePageImage
          imageKey="M5-P2-L9-1"
