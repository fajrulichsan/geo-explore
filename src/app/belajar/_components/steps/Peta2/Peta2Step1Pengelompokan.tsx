...
export default function Peta2Step1Pengelompokan({ materi, peta }: { materi: string; peta: string }) {
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <p className="m-0 text-[15px] leading-[1.6] text-[#374151] max-w-2xl">
          Langkah A: Mari kita diskusikan temuan kalian bersama-sama.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-white border border-[#E5E7EB] rounded-[20px] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04)] flex flex-col gap-6">
          <h3 className="m-0 flex items-center gap-2 text-lg font-bold text-[#111827]">
