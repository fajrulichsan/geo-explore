...
export default function Peta3Step3EksplorasiGeoGebra({ materi, peta }: { materi: string; peta: string }) {
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <h1 className="m-0 text-[32px] font-extrabold text-[#111827]">Eksplorasi GeoGebra 3D</h1>
        </div>
