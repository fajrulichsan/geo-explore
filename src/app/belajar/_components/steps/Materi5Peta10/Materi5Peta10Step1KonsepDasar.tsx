...
const alurKonsep = [
  ...
  { icon: "📏", label: "Setiap ukuran panjang menjadi k kali" },
  { icon: "▦", label: "Luas setiap sisi menjadi k² kali" },
  { icon: "🎯", label: "Luas Permukaan menjadi k² kali" },
];

export default async function Materi5Peta10Step1KonsepDasar({
  materi,
  peta,
  step = "1",
  editFoto,
      ...
      <div className="relative overflow-hidden rounded-[20px] bg-gradient-to-br from-[#1E3A8A] to-[#2563EB] p-6 grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-5 items-center">
        ...
        <div className="relative flex flex-col gap-2.5">
          ...
          <p className="m-0 text-sm sm:text-[15px] leading-[1.7] text-white/95 font-medium">
            Pada submateri ini kamu telah menemukan bahwa perubahan skala bangun ruang tidak hanya
            mengubah setiap ukuran panjang, tetapi juga mengubah luas permukaannya. Melalui
            kegiatan mengamati, berdiskusi, bereksplorasi menggunakan GeoGebra 3D dan Augmented
            Reality (AR), mengolah informasi, memverifikasi, dan menyimpulkan, kamu menemukan
            sendiri hubungan antara faktor skala dan luas permukaan bangun ruang sisi datar.
          </p>
        </div>
        <EditablePageImage
          ...
          urutan="1"
          src={heroImage}
          alt="Tiga siswa berdiskusi tentang faktor skala menggunakan laptop"
          editable={editFoto}
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="bg-white border border-[#E5E7EB] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-full py-2 px-5 text-sm font-bold text-[#2563EB]">
            Konsep Dasar — Alur Perubahan Skala terhadap Luas Permukaan
          </div>
        </div>
