...
const baris = [
  { icon: "🔷", label: "Bentuk dan susunan sisi" },
  { icon: "📐", label: "Pasangan bidang sisi sejajar" },
  { icon: "🧱", label: "Bentuk sisi yang dipilih sebagai alas" },
  { icon: "🔢", label: "Jumlah sisi/rusuk/titik sudut" },
];
