...
export default async function Peta6Step2Bandingkan({ materi, peta, step = "2", editFoto, initialAnswers }: StepComponentProps) {
  const answers = initialAnswers ?? {};
  const getValue = (key: string) => (typeof answers[key] === "string" ? (answers[key] as string) : "");
  const gambarReferensi = await getPageImage("M1-P6-L2-1");
        ...
        <div className="lg:col-span-8">
          <div className="bg-white border border-[#E5E7EB] rounded-[20px] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04)] flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                rows={4}
                name="answers.bukti_lebih_kuat"
                defaultValue={getValue("bukti_lebih_kuat")}
