...
const aspek = [
  ...
  { key: "lebih_satu", label: "Kemungkinan lebih dari satu jaring-jaring" },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        <div className="flex flex-col gap-4">
          ...
          <p className="m-0 text-sm text-[#4B5563]">
            Berdasarkan rumusan masalah dan dugaan kelompokmu, tuliskan prediksi jawaban yang menurut kelompokmu
            paling mungkin benar sebelum melakukan eksplorasi menggunakan GeoGebra 3D dan Augmented Reality.
          </p>
          <div className="rounded-[20px] border border-[#DDD6FE] bg-[#F5F3FF] p-5 flex flex-col gap-3">
            <label htmlFor="prediksi_jawaban" className="text-sm font-bold text-[#5B21B6]">
            ...
            <textarea
              ...
              placeholder="Tuliskan prediksi jawaban kelompokmu..."
              required
              rows={5}
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="m-0 text-sm text-[#4B5563]">
            Pilih aspek-aspek yang menurut kelompokmu akan menentukan apakah suatu susunan bidang datar
            ...
            {aspek.map((a) => (
              ...
              >
                <input
                  ...
                  data-require-group="aspek-diuji"
