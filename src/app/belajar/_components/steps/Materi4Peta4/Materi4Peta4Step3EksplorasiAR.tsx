...
export default async function Materi4Peta4Step3EksplorasiAR({
  materi,
  peta,
  step = "3",
  editFoto,
}: StepComponentProps) {
  const [gambarAR, gambarQr] = await Promise.all([getPageImage("M4-P4-L3-1"), getPageImage("qr-ar")]);
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-[20px] p-5 sm:p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04)] flex flex-col gap-5">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-5 items-start">
            <EditablePageImage
              ...
              urutan="1"
              src={gambarAR}
              alt="Tampilan kamera AR menunjukkan limas beserta tinggi, tinggi sisi tegak, dan panjang sisi alas"
              editable={editFoto}
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-2xl p-4 flex flex-col items-center gap-3">
              ...
              <p className="m-0 text-center text-xs text-[#6B7280]">
                Scan untuk menampilkan model limas secara nyata.
              </p>
            </div>
          </div>
          ...
          <div>
            <span className="text-xs font-bold text-[#111827] mb-2 block">Yang Diamati (AR)</span>
          ...
          <div className="bg-[#FEF9E7] rounded-xl py-3.5 px-[18px] flex items-start gap-3">
            ...
            <p className="m-0 text-sm font-bold text-[#92400E] leading-[1.5]">
              ...
              langsung membuat rumus. Gunakan hasil pengamatanmu sebagai dasar untuk menemukan
              pola pada tahap berikutnya.
            </p>
          </div>
        </div>
      </div>
