...
const baris = [
  { icon: "target", label: "Dasar klasifikasi" },
  { icon: "group", label: "Kelompok yang terbentuk" },
  { icon: "check", label: "Kelebihan" },
  { icon: "cross", label: "Kekurangan" },
];
...
export default function Peta8Step4MembandingkanStrategi({
  materi,
  peta,
}: {
  materi: string;
