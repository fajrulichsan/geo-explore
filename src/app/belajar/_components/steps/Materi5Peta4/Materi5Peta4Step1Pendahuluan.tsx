...
const alurEksplorasi = [
  { n: 1, label: "GeoGebra 3D", desc: "Ubah faktor skala (k) dan amati perubahan ukuran bangun ruang." },
  { n: 2, label: "Augmented Reality (AR)", desc: "Amati perubahan bentuk dan luas permukaan secara nyata." },
  { n: 3, label: "Catatan Data", desc: "Catat semua data untuk menguji dugaan kelompokmu." },
];
...
export default async function Materi5Peta4Step1Pendahuluan({
  ...
  const gambarSiswa = await getPageImage("M5-P4-L1-1");
    ...
    <form action={submitStepAction} className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="inline-flex items-center bg-[#FDF3C7] text-[#92400E] rounded-full py-1.5 px-3.5 text-xs font-bold tracking-[0.02em] w-fit">
          Submateri 5 &middot; Tahap 3 &middot; Ayo Bereksplorasi
        </div>
      </div>
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center gap-5">
          <div className="flex-1 flex flex-col gap-3">
            ...
            <p className="m-0 text-sm sm:text-[15px] leading-[1.6] text-white/90 max-w-xl">
              Sekarang saatnya menguji dugaan kelompokmu. Gunakan GeoGebra 3D dan Augmented
              Reality (AR) untuk mengubah faktor skala bangun ruang. Amati perubahan ukuran setiap
              sisi, hitung luas permukaan, lalu catat data yang digunakan untuk{" "}
              <span className="font-bold text-white">menguji dugaanmu</span>.
            </p>
          </div>
          <EditablePageImage
            imageKey="M5-P4-L1-1"
            ...
            urutan="1"
            src={gambarSiswa}
            alt="Tiga siswa mengamati bangun ruang di laptop dan tablet dengan berbagai faktor skala"
            editable={editFoto}
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          {alurEksplorasi.map((a, i) => (
            <div key={a.n} className="flex items-center gap-2">
              <div className="flex flex-col items-center gap-1.5 min-w-[130px] max-w-[170px]">
