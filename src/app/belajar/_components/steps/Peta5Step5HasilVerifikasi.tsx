...
export default function Peta5Step5HasilVerifikasi({ materi, peta }: { materi: string; peta: string }) {
  return (
    <>
            ...
            <div className="flex flex-col gap-3">
              {checklist.map((c) => (
                <label key={c} className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-0.5 rounded border-[#E5E7EB] text-[#2563EB]" />
