...
const checklist = [
  "mengelompokkan bangun ruang berdasarkan berbagai sifat.",
  "menjelaskan alasan matematis dari pengelompokan yang saya buat.",
  "mendiskusikan strategi pengelompokan dengan teman.",
  "menyampaikan dan mempertahankan pendapat dengan alasan yang tepat.",
  "memperbaiki jawaban apabila menemukan bukti atau alasan yang lebih kuat.",
  "menggunakan cara berpikir ini untuk mengelompokkan bangun ruang pada masalah yang berbeda.",
];

export default function Peta7Step3KeyakinanDiriku({ materi, peta }: { materi: string; peta: string }) {
  return (
    <>
