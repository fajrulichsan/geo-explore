...
export default function Peta9Step6MenemukanPrinsipUmum({
  materi,
  peta,
  initialAnswers,
}: StepComponentProps) {
            ...
            <div className="flex flex-col gap-2">
              {checklist.map((item) => (
                ...
                >
                  ...
                  <span className="text-sm text-[#374151] flex-grow peer-checked:text-[#111827] peer-checked:font-semibold">
                    {item.text}
                  </span>
                </label>
              ))}
