...
export default function Materi5Peta9Step2BandingkanStrategi({
  materi,
  peta,
  initialAnswers,
}: StepComponentProps) {
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <p className="m-0 text-xs text-[#6B7280]">
            Lengkapi tabel berikut untuk membandingkan Strategi 1 dan Strategi 2 yang kamu gunakan.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-[20px] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          <div className="overflow-x-auto">
            <table className="w-full border-collapse min-w-[720px]">
              <thead>
                <tr>
                  <th className="text-left text-xs font-bold text-[#374151] bg-[#F3F0FF] rounded-l-xl py-2.5 px-3.5 w-[22%]">
                    Hal yang Dibandingkan
                  </th>
                  <th className="text-left text-xs font-bold text-[#2563EB] bg-[#F3F0FF] py-2.5 px-3.5">
                    Strategi 1
                  </th>
                  <th className="text-left text-xs font-bold text-[#16A34A] bg-[#F3F0FF] rounded-r-xl py-2.5 px-3.5">
                    Strategi 2
                  </th>
                </tr>
              </thead>
                  ...
                  <tr key={b.key} className="border-b border-[#F3F4F6] last:border-none">
                    ...
                    <td className="py-3 px-3.5 align-top">
                      <textarea
                        ...
                        required
                        placeholder="Jawabanmu..."
                        className="w-full rounded-lg border border-[#E5E7EB] bg-[#F9FAFB] px-2.5 py-2 text-xs text-[#374151] placeholder:text-[#9CA3AF] focus:border-[#16A34A] focus:outline-none transition-colors resize-y"
                      />
                    </td>
                  </tr>
                ))}
        ...
        <div className="bg-[#F5F3FF] border border-[#DDD6FE] rounded-2xl p-5 flex items-start gap-3">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" strokeWidth="2" className="flex-shrink-0 mt-0.5">
            <path d="M8 12h.01M12 8v8m-6.5 3.5L2 22l3.5-3.5M22 12a10 10 0 11-20 0 10 10 0 0120 0z" />
          </svg>
          <div className="flex-1 flex flex-col gap-1.5">
            <p className="m-0 text-sm font-bold text-[#5B21B6]">Strategi mana yang menurutmu lebih efisien? Mengapa?</p>
            <textarea
              ...
              required
              placeholder="Jawabanmu..."
              className="w-full rounded-xl border border-[#DDD6FE] bg-white p-2.5 text-xs text-[#374151] placeholder:text-[#9CA3AF] focus:border-[#7C3AED] focus:outline-none transition-colors resize-y"
            />
          </div>
        </div>
      </div>
