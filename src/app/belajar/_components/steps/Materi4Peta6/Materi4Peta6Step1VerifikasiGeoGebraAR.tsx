...
const kegiatan = [
  "Buka kembali model limas pada GeoGebra 3D.",
  "Amati kembali jaring-jaring dan bentuk limas.",
  "Periksa ukuran alas dan setiap sisi tegak.",
  "Hitung kembali luas alas.",
  "Hitung kembali luas setiap sisi tegak (yang sama maupun yang berbeda).",
  "Jumlahkan luas alas dan luas seluruh sisi tegak.",
  "Cocokkan hasil perhitungan dengan jawaban kelompokmu.",
  "Periksa kembali melalui Augmented Reality (AR).",
];

const bangunRuang = [
  { key: "limas_segiempat", label: "Limas Segiempat", note: "Wajib" },
  { key: "limas_segitiga", label: "Limas Segitiga", note: "Opsional bila digunakan sebagai pembanding" },
];
    ...
    <form action={submitStepAction} className="flex flex-col gap-8">
      ...
      <div className="grid lg:grid-cols-12 gap-6 items-stretch">
        <div className="lg:col-span-8 bg-white border border-[#E5E7EB] rounded-[20px] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04)] flex flex-col gap-3">
          ...
          <p className="m-0 text-sm leading-[1.6] text-[#374151]">
            ...
            <span className="font-bold text-[#2563EB]">Augmented Reality (AR)</span>, dan diskusi
            dengan kelompok lain untuk memeriksa dan memperkuat hasil penemuanmu.
          </p>
        </div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-[20px] shadow-[0_1px_2px_rgba(0,0,0,0.04)] overflow-hidden">
        ...
        <div className="px-6 pt-4">
          <p className="m-0 mb-2 text-sm font-semibold text-[#374151]">
            Lakukan langkah-langkah berikut untuk memeriksa kembali hasil kelompokmu.
          </p>
          ...
          <div className="mt-3 bg-[#FEF9E7] border border-[#F5E3A0] rounded-2xl p-3.5 flex items-start gap-2.5">
            ...
            <p className="m-0 text-xs text-[#92400E] leading-[1.5]">
              <span className="font-bold">Ingat!</span> Luas alas dihitung satu kali, luas semua sisi
              tegak yang membatasi limas telah diperhitungkan, dan tidak ada sisi yang terlewat.
            </p>
          </div>
        </div>

        <div className="px-6 py-5 overflow-x-auto">
          <p className="m-0 mb-3 text-sm font-bold text-[#111827]">Tabel Hasil Verifikasi</p>
              ...
              {bangunRuang.map((b) => (
                <tr key={b.key}>
                  <td className="px-4 py-3 align-top">
                    ...
                    <p className="m-0 text-xs text-[#6B7280]">{b.note}</p>
                  </td>
                  <td className="px-4 py-3 align-top">
                      ...
                      {(["sesuai", "perlu_diperbaiki"] as const).map((opt) => (
                        <label key={opt} className="flex flex-col items-center gap-1 cursor-pointer">
                          <input
                            ...
                            required={b.key === "limas_segiempat"}
